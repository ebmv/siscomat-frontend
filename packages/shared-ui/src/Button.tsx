...
export const Button = ({
  ...
  const base =
    "flex w-full items-center justify-center px-14 py-3.5 rounded-lg label-large transition-all duration-200 outline-none focus:ring-2 focus:ring-offset-2 gap-3";
